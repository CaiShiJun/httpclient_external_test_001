...
<head>
    ...
    <script>
        ...
        function asynchttpclientFun(type) {
            if (checkUrl('asynchttpclientGetUrl', 'check4'))
            {
                if (type == 'AsyncHandler execute') {
                    document.forms['asynchttpclient_form'].action = "/asynchttpHandler";
                } else document.forms['asynchttpclient_form'].action = "/asynchttpGet";
                document.forms['asynchttpclient_form'].submit();
            }
...
<table>
    <tr>
        ...
        <td valign="top">
            ...
            <form name="asynchttpclient_form">
                <p>AsyncHttpClient url：
                    ...
                    <input type="button" value="execute" onclick="asynchttpclientFun('execute');">
                    <input type="button" value="AsyncHandler execute"
                           onclick="asynchttpclientFun('AsyncHandler execute');">
